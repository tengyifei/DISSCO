...
public:
    /**
    *	This is the constructor.  There are no parameters since it assumes 
    ...
    *	\param env The envolope to copy
    *	\return A copy of env
    **/
    Envelope (const Envelope &env);

    /**
    * Constructor - Make new envelope using a collection of envelope segments 
    * and points
    **/
