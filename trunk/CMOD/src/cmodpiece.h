...
//---------------------------------------------------------------------------//
    /**
     *  Default constructor for a CMODPiece.
     **/
    CMODPiece(){}

    /**
     *  CMODPiece copy constructor.
     *	\param orig CMODPiece object to make a copy of
     **/
    CMODPiece(const CMODPiece& orig);

    /**
     *	Assignment operator
     *	\param rhs The CMODPiece to assign
     **/
    CMODPiece& operator= (const CMODPiece& rhs);

    /**
     *	CMODPiece destructor.
     **/
    ~CMODPiece();
